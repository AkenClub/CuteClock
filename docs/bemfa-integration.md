...
还支持巴法云控制台直接输入指令控制，方便调试，相当于多了一种远程控制方式，即使没有米家 APP 也可以控制。

## 📋 支持的设备类型

根据巴法云小爱同学接入规则，系统支持以下设备类型：

| 设备类型 | 主题后缀 | 功能说明 | 小爱控制示例 |
|---------|----------|----------|-------------|
| 灯泡设备 | 002 | 开关控制 | "小爱同学，打开/关闭灯" |
| 传感器设备 | 004 | 温度上报 | "小爱同学，查询传感器温度" |
| 开关设备 | 006 | PC电源控制 | "小爱同学，打开/关闭开关" |
